...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2021 at 10:57 AM
...
INSERT INTO `admission` (`admission_id`, `patient_id`, `room_number`, `bed_number`, `admission_date`, `relese_date`) VALUES
...
--
ALTER TABLE `employee`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
