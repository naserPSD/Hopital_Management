...
(194, 3004, 1010, 703, '2021-05-12', '2021-05-13');
...
(4, 1010, 703, 'Available'),
(5, 1010, 704, 'Available'),
(6, 1010, 705, 'Available'),
(7, 1020, 801, 'Available'),
(8, 1020, 802, 'Available'),
(9, 1030, 901, 'Available');
...
(4, 3004, 194, '2021-05-13', 20000.00, 500, 'Paid');
...
('Cardiology', '3rd floor, East Building', 'Available'),
...
(105, 'Rahim', 'Ahmed', 'Cardiology', 'male', 'B+');
...
(4, 'Medical Report', 102, 3002, '2021-05-03', 'Akash'),
(5, 'prescription', 101, 3003, '2021-05-10', 'Reception');
...
(8, 103, 'Surgery', 'Sat', '03:49:00', '03:49:00', 'Available');
...
(215, 'Shakil', 'khan', '2021-04-28', 'Radiotherapy', '01753616445', 'male', 'Operator', 'A+'),
(216, 'Ratul', 'Hassan', '2021-05-19', 'Cardiology', '018756431', 'male', 'Operator', 'B+');
...
(5, 215, 9001, 'sunday', 'morning', 'Available');
...
(3007, 'Salma', 'sheikh', '01853619694', 'Dhaka, Bangladesh', 'Female', '2021-10-10');
...
--
ALTER TABLE `admission`
  MODIFY `admission_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;

--
-- AUTO_INCREMENT for table `bill`
--
ALTER TABLE `bill`
  MODIFY `bill_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `document`
  MODIFY `document_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dshedule`
--
ALTER TABLE `dshedule`
  MODIFY `sl` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `eshedule`
  MODIFY `sl` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `patient`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3008;
